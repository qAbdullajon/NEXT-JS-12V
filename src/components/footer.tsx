    ...
    <footer className="text-gray-600 px-8 body-font">
      <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
        ...
        <p className="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">
          © {format(new Date(), 'yyyy')} Button —
          <a href="https://t.me/qAbdullajon" className="text-gray-600 ml-1" rel="noopener noreferrer" target="_blank">
            @qAbdullajon
          </a>
        </p>
        <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
          ...
          <a href="https://x.com/" target="_blank" className="ml-3 text-gray-500">
            <svg fill="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} className="w-5 h-5" viewBox="0 0 24 24">
          ...
          <a href="https://www.linkedin.com/" target="_blank" className="ml-3 text-gray-500">
